...
// Cross Module References
	...
	ASISTIVNA_API UFunction* Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte();
...
// End Cross Module References
	void AAsistivnaGameMode::StaticRegisterNativesAAsistivnaGameMode()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PobrisiLopte", &AAsistivnaGameMode::execPobrisiLopte },
	...
	struct Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde_Statics::Function_MetaDataParams[] = {
		{ "Category", "ResetMap" },
		{ "ModuleRelativePath", "AsistivnaGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAsistivnaGameMode, nullptr, "KrajRunde", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AAsistivnaGameMode_KrajRunde_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte_Statics::Function_MetaDataParams[] = {
		{ "Category", "ResetMap" },
		{ "ModuleRelativePath", "AsistivnaGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAsistivnaGameMode, nullptr, "PobrisiLopte", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_udaljenostLopte_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_udaljenostLopte;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_brRunde_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_brRunde;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAsistivnaGameMode_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AAsistivnaGameMode_PobrisiLopte, "PobrisiLopte" }, // 220965326
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_udaljenostLopte_MetaData[] = {
		{ "Category", "udaljenostLopte" },
		{ "ModuleRelativePath", "AsistivnaGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_udaljenostLopte = { "udaljenostLopte", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAsistivnaGameMode, udaljenostLopte), METADATA_PARAMS(Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_udaljenostLopte_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_udaljenostLopte_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_brRunde_MetaData[] = {
		{ "Category", "brRunde" },
		{ "ModuleRelativePath", "AsistivnaGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_brRunde = { "brRunde", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAsistivnaGameMode, brRunde), METADATA_PARAMS(Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_brRunde_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_brRunde_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAsistivnaGameMode_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_udaljenostLopte,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAsistivnaGameMode_Statics::NewProp_brRunde,
	...
	IMPLEMENT_CLASS(AAsistivnaGameMode, 2754193953);
